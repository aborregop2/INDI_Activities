...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  protected:
    ...
    GLint ample, alt;
    // uniform locations
    GLuint transLoc, projLoc, viewLoc, posfocusLoc, LLoc, eleLoc;
    // attribute locations
    ...
    bool focusCam = true, camera2 = false;
    float anglePatri = 0.f;
    int upCounter = 0;
    ...
    public slots:
        void cam2();
        void cam2sig(bool b);
        void rotatePatri(int a);
        void rotatePatsig(int a);
